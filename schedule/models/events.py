...
class Event(models.Model):
    ...
    end = models.DateTimeField(_("fin"), help_text=_("The end time must be later than the start time."))
    title = models.CharField(_("titulo"), max_length=255)
    description = models.TextField(_("descripcion"), null=True, blank=True)
    creator = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, blank=True, verbose_name=_("creador"),
                                related_name='creator')
    created_on = models.DateTimeField(_("creado el"), default=timezone.now)
    rule = models.ForeignKey(Rule, null=True, blank=True, verbose_name=_("regla"),
                             help_text=_("Seleccione '----' para eventos de una sola ocurrencia."))
    end_recurring_period = models.DateTimeField(_("fin del periodo recurrente"), null=True, blank=True,
                                                help_text=_("Esta fecha es ignorada para eventos no recurrentes."))
