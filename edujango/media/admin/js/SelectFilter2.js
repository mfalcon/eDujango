...
var SelectFilter = {
    init: function(field_id, field_name, is_stacked, admin_media_prefix) {
        ...
        var search_selector_img = quickElement('img', search_filter_label, '', 'src', '/media/admin/' + 'img/admin/selector-search.gif');
        ...
        quickElement('img', selector_filter, '', 'src', '/media/admin/' + (is_stacked ? 'img/admin/selector_stacked-add.gif':'img/admin/selector-add.gif'), 'alt', 'Add');
